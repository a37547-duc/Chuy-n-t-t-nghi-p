          ...
          <div className="grid grid-cols-2 gap-8 py-8 lg:grid-cols-4 text-sm">
            <div>
              ...
              <ul className="text-gray-500 dark:text-gray-400 space-y-4">
                <li>
                  <a href="#" className="hover:text-blue-500 dark:hover:text-white transition-colors">Máy tính bàn</a>
                </li>
                <li>
                  <a href="#" className="hover:text-blue-500 dark:hover:text-white transition-colors">Laptop</a>
                </li>
                <li>
                  <a href="#" className="hover:text-blue-500 dark:hover:text-white transition-colors">Linh kiện</a>
                </li>
                <li>
                  <a href="#" className="hover:text-blue-500 dark:hover:text-white transition-colors">Phụ kiện</a>
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="text-gray-500 dark:text-gray-400 space-y-4">
                <li>
                  <a href="#" className="hover:text-blue-500 dark:hover:text-white transition-colors">Chính sách bảo hành</a>
                </li>
                <li>
                  <a href="#" className="hover:text-blue-500 dark:hover:text-white transition-colors">Chính sách đổi trả</a>
                </li>
                <li>
                  <a href="#" className="hover:text-blue-500 dark:hover:text-white transition-colors">Liên hệ</a>
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="text-gray-500 dark:text-gray-400 space-y-4">
                <li>
                  <a href="#" className="hover:text-blue-500 dark:hover:text-white transition-colors">Giới thiệu</a>
                </li>
                <li>
                  <a href="#" className="hover:text-blue-500 dark:hover:text-white transition-colors">Tin tức</a>
                </li>
              </ul>
            </div>
            <div>
